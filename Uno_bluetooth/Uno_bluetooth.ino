...
bool improprerTemperature = false;
...
void loop()
{
  ...
  if (bluetooth.available())
  {
    ...
    if (pythonMessage.indexOf("improperTemperatureSet") > -1)
    {
      bluetooth.print("Waiting temperature...");
      improprerTemperature = true;
    }
    if (pythonMessage.indexOf("improperTemperatureReset") > -1)
    {
      bluetooth.print("Running normally");
      improprerTemperature = false;
    }
  }
